...
if (exists("readcounts") == F) {
  ...
  file.copy(from = mrna.files, to = file.path(folder, data))
  
  mrna.reads <- lapply(list.files(file.path(folder, data), 
                                  pattern = "counts.txt$",
                                  full.names = T), 
...
# old <- openxlsx::read.xlsx("C:/Users/HMarton/Documents/Reni_project/Table_S3.xlsx")
# setdiff(old$geneID, Ca11_6h.res$sig_df$geneID)

# #"C7orf31"      "LOC93622"     "C2orf16"      "LOC105373951" "LOC100128007"

# tmp[which(tmp$geneID %in% c("C7orf31","LOC93622","C2orf16","LOC105373951","LOC100128007")),]

# # baseMean log2FoldChange     lfcSE      stat       pvalue
# # 478  ENSG00000153790 162.05814      -1.582610 0.2549864 -6.206646 5.412720e-10
# # 623  ENSG00000170846 374.49280      -1.567910 0.1822953 -8.600935 7.906938e-18
# # 1002 ENSG00000221843  29.84773      -2.955524 0.5092184 -5.804041 6.473538e-09
# # 1018 ENSG00000227252  18.78178      -2.206084 0.5316035 -4.149868 3.326673e-05
# # 1151 ENSG00000262503  15.07746      -3.610545 0.7940147 -4.547202 5.436369e-06
# # padj           significance       geneID  entrezID
# # 478  8.985480e-09 Signif. down-regulated      C7orf31    136895
# # 623  3.863927e-16 Signif. down-regulated     LOC93622     93622
# # 1002 8.638017e-08 Signif. down-regulated      C2orf16     84226
# # 1018 1.833957e-04 Signif. down-regulated LOC105373951 105373951
# # 1151 3.693828e-05 Signif. down-regulated LOC100128007 100128007
...
# merge the cancer hallmark genesets with the C.albicans and C.parapsilosis 
# DESeq2 results
...
# Create the data frames for venn diagrams
...
ű# locate the centroid of subsets and their populations
